...
export const GALLERY_IMAGES: GalleryImage[] = [
  ...
  {
    id: 'g-17',
    title: 'Condo balcony rails',
    category: 'balcony',
    caption: 'Finished balcony rails on a multi-level residential building.',
    alt: 'Multi-level condominium balconies with glass and metal rails',
    thumb: '/gallery/big/balcony_17.jpg',
    full: '/gallery/big/balcony_17.jpg',
  },
  {
    id: 'g-18',
    title: 'Elevated glass-rail balcony',
    category: 'balcony',
    caption: 'An elevated balcony with a glass rail and a waterproof walking surface below.',
    alt: 'Elevated residential balcony with a glass rail over a driveway',
    thumb: '/gallery/big/balcony_18.jpg',
    full: '/gallery/big/balcony_18.jpg',
  },
  {
    id: 'g-20',
    title: 'Waterfront timber home',
    category: 'lakefront',
    caption: 'Upper and lower decks on a waterfront home, with rails that keep the view open.',
    alt: 'Timber waterfront home with upper and lower decks and metal rails',
    thumb: '/gallery/big/balcony_20.jpg',
    full: '/gallery/big/balcony_20.jpg',
    featured: true,
  },
  {
    id: 'g-21',
    title: 'Stacked condo balconies',
    category: 'balcony',
    caption: 'A continuous balcony rail line on a multi-story residential building.',
    alt: 'Curved stacked condominium balconies with black metal rails',
    thumb: '/gallery/big/balcony_21.jpg',
    full: '/gallery/big/balcony_21.jpg',
  },
  {
    id: 'g-22',
    title: 'Waterfront balcony seating',
    category: 'lakefront',
    caption: 'A finished balcony walking surface looking out over the water.',
    alt: 'Round waterfront balcony with a table and chairs on a vinyl surface',
    thumb: '/gallery/big/balcony_22.jpg',
    full: '/gallery/big/balcony_22.jpg',
  },
  {
    id: 'g-23',
    title: 'Waterside vinyl deck',
    category: 'lakefront',
    caption: 'A waterproof vinyl walking surface with a glass rail toward the water.',
    alt: 'Gray vinyl deck with a glass rail overlooking a waterway',
    thumb: '/gallery/big/balcony_23.jpg',
    full: '/gallery/big/balcony_23.jpg',
  },
  {
    id: 'g-24',
    title: 'Open waterfront deck',
    category: 'lakefront',
    caption: 'An open deck and rail facing an unobstructed water view.',
    alt: 'Open waterfront deck with a glass rail facing the horizon',
    thumb: '/gallery/big/balcony_24.jpg',
    full: '/gallery/big/balcony_24.jpg',
  },
  {
    id: 'g-25',
    title: 'Fenced pool deck',
    category: 'pool',
    caption: 'A pool enclosure with a finished walking surface and an open glass rail.',
    alt: 'In-ground pool enclosed by a glass rail with a deck and seating',
    thumb: '/gallery/big/balcony_25.jpg',
    full: '/gallery/big/balcony_25.jpg',
  },
  {
    id: 'g-26',
  ...
  {
    id: 'g-27',
    title: 'Dining deck by the trees',
    category: 'deck',
    caption: 'A finished dining deck and pool edge looking into the trees.',
    alt: 'Outdoor dining table on a deck beside a pool with a treeline view',
    thumb: '/gallery/big/balcony_27.jpg',
    full: '/gallery/big/balcony_27.jpg',
  },
];
...
export const CUSTOMER_PROJECTS: CustomerProject[] = [
  ...
  },
  {
    ...
    images: [
      ...
      { src: '/gallery/projects/loudon/before-2.jpg', alt: 'Wood deck framing in Loudon, Tennessee before DeckRite vinyl' },
    ],
  },
  {
    id: 'michigan',
    ...
    caption: 'Tuscany Sand vinyl as the finished floor for outdoor dining, from prep through the welded surface.',
    images: [
      ...
      { src: '/gallery/projects/michigan/prep.jpg', alt: 'Tuscany Sand vinyl being rolled onto a prepared deck in Michigan' },
      { src: '/gallery/projects/michigan/weld.jpg', alt: 'Hot-air welding Tuscany Sand vinyl on a Michigan deck' },
    ],
  },
  {
    id: 'oak-harbor',
    ...
    pattern: 'Slate Gray',
    caption: 'Slate Gray vinyl on a residential balcony.',
    images: [
